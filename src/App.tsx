...
// Data structure for the D3 tree diagram, moved outside the component
const diagramData = {
  name: "Pipeline",
  children: [
    {
      name: "Input",
      children: [
        { name: "3D Mesh Input", description: "High-fidelity garment geometry with material properties" }
      ]
    },
    {
      name: "Processing",
      children: [
        { name: "Physics Simulation", description: "Real-time cloth simulation with wind, gravity, collision forces" },
        { name: "Data Capture", description: "36-camera array capturing 8K@60fps with metadata tagging" },
        { name: "Data Processing", description: "Metadata tagging and file organization" }
      ]
    },
    {
      name: "AI & Output",
      children: [
        { name: "AI Training", description: "Neural network training with physics-constrained datasets" },
        { name: "AI Enhancement", description: "AI-driven post-processing for visual fidelity" },
        { name: "Enhanced Output", description: "Stable, enterprise-ready AI with physics accuracy" }
      ]
    }
  ]
};

// Component for the dynamic D3 diagram, moved to top-level scope
const TechnologyDiagram = () => {
  ...
  useEffect(() => {
    ...
    if (!container.node()) return; // Added guard clause
    
    const width = container.node().getBoundingClientRect().width;
    const height = 500; // Set a fixed height for the SVG to prevent it from collapsing
    ...
    nodes.append('text')
      ...
      .attr('class', 'text-sm font-semibold fill-gray-900')
      .text(d => d.data.name);

  }, []); // Empty dependency array means this effect runs once on mount

  return (
    <div className="bg-gray-50 rounded-3xl p-12 relative overflow-hidden flex items-center justify-center">
...
const App = () => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20 sm:mb-32">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Current GenAI models are unusable for enterprise. They're unstable, unpredictable, and ethically risky — costing companies millions in failed deployment attempts.
            </p>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We deliver real‑world simulation through API — at scale. 23Bulbs delivers tagged, physics-accurate training data via a powerful simulation engine that reduces training requirements from <span className="text-blue-500 font-semibold">500M frames to just 500</span>.
            </p>
          </div>
          {/* Technology Pipeline Diagram */}
          <div className="mb-20 sm:mb-32">
            <h3 className="text-2xl sm:text-3xl font-bold text-black mb-12 sm:mb-16 text-center">Physics-Aware Data Pipeline</h3>
            <TechnologyDiagram />
          </div>
          {/* Features Grid */}
          <div className="mb-20 sm:mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="bg-gray-50 rounded-3xl p-12">
                <h3 className="text-2xl font-bold text-black mb-8">Current GenAI Problems</h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <X className="w-4 h-4 text-red-500" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-black mb-2">Unstable Generation</h4>
                      <p className="text-gray-600">Video output degrades after 4-8 seconds, making it unsuitable for professional use</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-semibold text-black mb-2">Blocked Enterprise Adoption</h4>
                      <p className="text-gray-600">Companies can't deploy at scale due to unreliable outputs and legal risks</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-semibold text-black mb-2">Copyright & Legal Risks</h4>
                      <p className="text-gray-600">Training on copyrighted content creates liability exposure for enterprises</p>
                    </div>
                  </div>
                </div>
              </div>
              {/* Our Solution */}
              <div className="bg-gray-50 rounded-3xl p-12">
                <h3 className="text-2xl font-bold text-black mb-8">23Bulbs Solution</h3>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <Check className="w-4 h-4 text-green-500" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-black mb-2">Physics-Based Simulation</h4>
                      <p className="text-gray-600">Real-time cloth simulation with accurate wind, gravity, and collision physics</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-semibold text-black mb-2">Multi-Camera Data Capture</h4>
                      <p className="text-gray-600">36-perspective camera array capturing 8K 60fps with AOV render passes</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-6 h-6 mt-1 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      <h4 className="font-semibold text-black mb-2">Zero Copyright Risk</h4>
                      <p className="text-gray-600">100% synthetic data generated from physics simulations, not scraped content</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
              <div>
                <div className="text-3xl sm:text-4xl font-bold mb-3">
                  <span className="text-red-400">500M</span>
                  <span className="text-gray-400 text-2xl mx-2">→</span>
                  <span className="text-green-400">500</span>
                </div>
                <div className="text-gray-400 text-sm">Training Frames Required</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-3">45TB</div>
                <div className="text-gray-400 text-sm">Dataset Volume Generated</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-3">8K@60fps</div>
                <div className="text-gray-400 text-sm">Video Resolution & Frame Rate</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl font-bold text-green-400 mb-3">4 Years</div>
                <div className="text-gray-400 text-sm">Technical Development Lead</div>
              </div>
            </div>
          </div>
        </div>
  ...
  // Renders the contact sales page
  const CheckoutPage = () => (
    <div className="min-h-screen bg-white" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", Inter, sans-serif' }}>
      <header className="px-4 sm:px-6 py-6 sm:py-8 border-b border-gray-100">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
